...
export default function Sidebar({ show, setter }) {
  ...
  return (
    <div>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
              <img
                ...
                alt="FlowBite Logo"
              />
              <span class="self-center text-blue-500 text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">
                HerCareerLink
              </span>
            </div>
                      ...
                      {user && (
                        <div className="flex">
                          ...
                          >
                            ...
                            <span className="dark:text-gray-400">Inbox</span>
                          </button>
                          {showContactedUsers && (
      ...
      <aside
        id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen  pt-24  transition-transform -translate-x-full bg-[#F3F4F6] border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
        <div class="h-full px-3 pb-4 mr-6 overflow-y-auto bg-[#F3F4F6] dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">My Jobs</span>
              </a>
            </li>
            <li>
              <a
